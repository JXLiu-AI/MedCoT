from OpenEndTrain import OpenAnswerDataset
...
def eval_loop(_args):
    ...
    save_path = os.path.join('/data/Kat/mm_cot/OpenExperiments/', _args.output_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rationale', action='store_true', default=False)

...
class MoELayer(nn.Module):
    ...
    def forward(self, x):
        ...
        expert_outputs = torch.stack([expert(x_reshaped) for expert in self.experts], dim=1)  # [batch_size * seq_len, num_experts, output_dim]
...
class JointEncoder(T5Stack):
    def __init__(self, config, embed_tokens=None, patch_size=None, num_experts=1, expert_input_dim=768, expert_hidden_dim=1024, expert_output_dim=768):
        ...
        self.moe_layer = MoELayer(num_experts=num_experts, input_dim=expert_input_dim, hidden_dim=expert_hidden_dim, output_dim=expert_output_dim)
